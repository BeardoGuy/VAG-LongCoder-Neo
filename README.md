...
.NET 10 Desktop Runtime required — download from https://dotnet.microsoft.com/download/dotnet/10.0 — pick → Windows x64 Installer
## Features:  
...
## Usage:
  ...
  * When the program starts, it automatically loads the HEX string from the clipboard if a valid coding string is present.  
### For use  with VCDS: 
